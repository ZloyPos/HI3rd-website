...
<body>
    <?php include("nav.php"); ?>
    <div class="title"><span>ТИР-ЛИСТ</span></div>
    <div class="tierlist">
        <div class="tier-list">
            <div class="tier-header">
                ...
                <div class="tier-container">
                    <div class="header s-support">Саппорты S ранга</div>
                    <div class="header sp-support">SP саппорты</div>
                    <div class="header dd">Рекомендуемые ДД</div>
                    <div class="header dd-low">ДД (Низкий приоритет)</div>
                </div>
            </div>
            <div class="tier lightning">
                <div class="team-type lightning">
            ...
            <div class="tier physical">
                <div class="team-type physical">
